 ...
 * @tree: it's pointing to the tree to be checked
...
/**
 * bal_avl - function auxiliary to compare each subtree if its AVL
 * @tree: it's pointing to the tree to check
 * @high: it's pointing to the higher node selected
 * @lower: it's pointing to the lower node selected
 * Return: 1 if tree is AVL, 0 otherwise
 */
